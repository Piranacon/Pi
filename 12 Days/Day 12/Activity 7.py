# Description: This program will cycle through a dictionary of colours and display the key on the LCD and the colour on the LED strand
...
while True:
    ...
    for i in mycolours:
        ...
        lcd.putstr(str(i)) # Show the disctionary key name
